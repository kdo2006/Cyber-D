...
from fun.logo import about1
from fun.logo import about2
from fun.logo import about3
from fun.logo import about4
from fun.logo import logo
from fun.logo import social_media
...
def T_Bomber():
    user=input(colored("Do you want to install it?(y/n):", "red"))
    if user=="y":
        os.system("pkg install python -y  && cd $HOME && cd .tools && git clone https://github.com/TheSpeedX/TBomb.git ")
